          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                validator: (value) {
                  if (value!.isEmpty) {
                    return "Describe Your Current Medication Situation";
                  }

                  return null;
                },
                autovalidateMode: AutovalidateMode.onUserInteraction,
                controller: controller.curentMedication,
                decoration:
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (exist == false) {
                      if (controller.gender.trim().isNotEmpty) {
                        final patient = PatientCollection(
                            ...
                            currentMedication:
                                controller.curentMedication.text.trim());
                        SignupController.instance.createPatient(patient);
                        controller.clear();
                      } else {
